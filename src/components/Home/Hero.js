    ...
    return (
        <div className="hero__area" style={{ backgroundImage: `url(${herobg})` }}>
            <div className="container mx-auto px-4">
                <div className="row">
                    <div className="lg:w-1/3 w-full pt-[70px]">
                        <h1 className="text-6xl font-bold leading-tight mb-5 text-white">Easy way to find the right car</h1>
                    ...
                    <div className="lg:w-3/5 w-full ml-auto p-12">
