...
import Minutes from '../../assets/img/whyCarResell/Minutes.svg';
import carImg from '../../assets/img/whyCarResell/car.svg';
import pricing from '../../assets/img/whyCarResell/transparent.svg';
const WhyCarResell = () => {
    return (
        <div className='why-car-resell py-12'>
            <div className="container">
                ...
                <div className="grid gap-2 md:grid-cols-3 grid-cols-1 mt-12">
                    <div className="why-car-resell-item p-6 shadow-lg text-center border">
                        <div>
